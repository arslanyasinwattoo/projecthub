								...
								<tr>
									...
									<td><div class="input-group-btn">
											...
											<ul class="dropdown-menu">
												<li><a
													href="${pageContext.request.contextPath}/sysadmin/updateInstituteStatus.bnu?id=${user.instituteId}&amp;name=${user.instituteName}&amp;block=${user.block}&amp;enabled=1&amp;check=2">Remove</a></li>
											</ul>
										</div></td>
								</tr>
							</c:forEach>
						...
						<c:forEach items="${blockedList}" var="user">
							<tr>
								...
								<td><div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li><a
												href="${pageContext.request.contextPath}/sysadmin/updateInstituteStatus.bnu?id=${user.instituteId}&amp;name=${user.instituteName}&amp;block=0&amp;enabled=${user.pending}&amp;check=2">Remove</a></li>
										</ul>
									</div></td>
							</tr>
						</c:forEach>
