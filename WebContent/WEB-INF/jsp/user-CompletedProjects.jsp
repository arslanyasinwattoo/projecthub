							...
							<tr>
								...
								<td><div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li><a
												href="${pageContext.request.contextPath}/user/updateProjectStatus.bnu?id=${user.projectId}&amp;status=ongoing&amp;block=${user.block}&amp;check=5&amp;projectName=${user.projectName}&amp;projectDuration=${user.projectDuration}&amp;
											...
											<li><a
												href="${pageContext.request.contextPath}/user/updateProjectStatus.bnu?id=${user.projectId}&amp;status=Completed&amp;block=${user.block}&amp;check=5&amp;projectName=${user.projectName}&amp;projectDuration=${user.projectDuration}&amp;
											...
											<li><a
												href="${pageContext.request.contextPath}/user/updateProjectStatus.bnu?id=${user.projectId}&amp;status=Dumped&amp;block=${user.block}&amp;check=5&amp;projectName=${user.projectName}&amp;projectDuration=${user.projectDuration}&amp;
