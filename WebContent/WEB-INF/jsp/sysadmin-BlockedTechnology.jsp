								...
								<tr>
									...
									<td><div class="input-group-btn">
											...
											<ul class="dropdown-menu">
												<li><a
													href="${pageContext.request.contextPath}/sysadmin/updateTechnologyStatus.bnu?id=${user.toolsAndTechnologyId}&amp;name=${user.toolsAndTechnologyName}&amp;block=0&amp;check=2">Remove</a></li>
											</ul>
										</div></td>
								</tr>
							</c:forEach>
