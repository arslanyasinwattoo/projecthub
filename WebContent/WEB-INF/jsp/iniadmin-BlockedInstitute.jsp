								...
								<tr>
									...
									<td><div class="input-group-btn">
											...
											<ul class="dropdown-menu">
												<li><a
													href="${pageContext.request.contextPath}/iniadmin/updateInstituteStatus.bnu?id=${user.institute.instituteId}&amp;name=${user.institute.instituteName}&amp;block=0&amp;enabled=${user.institute.pending}&amp;check=2">Remove</a></li>
											</ul>
										</div></td>
								</tr>
							</c:forEach>
