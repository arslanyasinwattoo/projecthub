							...
							<tr>
								...
								<td><div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li><a
												href="${pageContext.request.contextPath}/user/updateProjectStatus.bnu?id=${user.projectId}&amp;status=${user.projectStatus}&amp;block=1&amp;check=4&amp;projectName=${user.projectName}&amp;projectDuration=${user.projectDuration}&amp;
