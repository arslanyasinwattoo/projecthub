	...
	<div class="container">
		...
		<div class="signin">
			...
			<div class="row row-sm-offset-3">
				<div class="col-xs-12 col-sm-6">
					<form
						action="${pageContext.request.contextPath}/sysadmin/SaveKeywords.bnu"
						autocomplete="off" method="POST" class="signin-form">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user"></i>
							</span> <input type="text" name="name" placeholder="Keyword"
								class="form-control">
						</div>
							...
							<c:forEach items="${ListOfKeywords}" var="user">
								<tr>
									...
									<td><div class="input-group-btn">
											...
											<ul class="dropdown-menu">
												<li><a
													href="${pageContext.request.contextPath}/sysadmin/updateKeywordStatus.bnu?id=${user.keywordsId}&amp;name=${user.keywordName}&amp;block=1&amp;check=1">block</a></li>
											</ul>
										</div></td>
								</tr>
							</c:forEach>
